...
public class SwipeListView extends ListView {
     ...
     */
    public final static int SWIPE_ACTION_REVEAL_NO_ANIM = 3;
	...
	public OnScrollListener getScrollListener(){
		return touchListener.getScrollListener();
	}
    ...
    private void init(AttributeSet attrs) {
    	setContentDescription("SwipeListView");
    ...
    public void resetScrolling() {
    	Log.e("swipe list view","touch state before reset:"+ touchState);
    ...
    public interface extraActionOnTouch{
    	void onTouch();
    }
    
    private extraActionOnTouch mExtraActionOnTouch;
    
    public void setExtraActionOnTouch(extraActionOnTouch ltn){
    	mExtraActionOnTouch = ltn;
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if(mExtraActionOnTouch!=null){
    		mExtraActionOnTouch.onTouch();
    	}
    ...
    public void closeOpenedItems(boolean resetScrolling) {
        touchListener.closeOpenedItems(resetScrolling);
    }
